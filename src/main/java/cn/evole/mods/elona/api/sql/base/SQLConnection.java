...
/**
 * Name: Elona / SQLConnection
 * Author: cnlimiter
 * CreateTime: 2023/9/3 21:55
 * Description:
 */
...
public class SQLConnection {
    ...
    public SQLConnection(String connectionUrl, Properties properties) {
        try {
            ...
            SqlUtil.log(Level.ERROR, "Failed to connect to database!");
            e.printStackTrace();
        }
    }
    ...
    public void close() {
        try {
            ...
            SqlUtil.log(Level.ERROR, "Gonna be honest, not sure how you got this one.");
            e.printStackTrace();
        }
    }
